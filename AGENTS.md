...
Repository classification: **SPECIAL** — organization profile and workflow templates.

This repository is **SPECIAL**. Its Codex guidance is intentionally limited; no repository-local automated review, repair, or merge workflow is enabled.
